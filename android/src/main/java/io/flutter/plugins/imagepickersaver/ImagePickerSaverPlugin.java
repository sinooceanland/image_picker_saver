...
public class ImagePickerSaverPlugin
    ...
    static final String METHOD_CALL_SAVE = "saveImage";
     ...
     */
    // See also: * {@link #ImagePickerSaverPlugin(ImagePickerDelegate, Activity)} for testing.
    public ImagePickerSaverPlugin() {}

    @VisibleForTesting
    ImagePickerSaverPlugin(final ImagePickerDelegate delegate, final Activity activity) {
